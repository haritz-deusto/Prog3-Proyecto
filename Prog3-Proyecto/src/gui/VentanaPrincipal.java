...
public class VentanaPrincipal extends JFrame {
    ...
    private JMenuItem itemCuenta, itemGenero1, itemGenero2, itemGenero3, itemGenero4, itemGenero5, itemGenero6, itemGenero7, itemBuscar, itemSorprendeme, itemMaraton;
    private JMenu visualizarCuenta, visualizarPeliculas, menuExtras;
    ...
    public VentanaPrincipal() {
        ...
        itemMaraton = new JMenuItem("Maratón");
        menuExtras.add(itemSorprendeme);
        menuExtras.add(itemMaraton);

        barraMenu.add(visualizarCuenta);
        barraMenu.add(visualizarPeliculas);
        barraMenu.add(itemBuscar);
        barraMenu.add(menuExtras);
        ...
        itemCuenta.addActionListener(e -> {
            ...
            logger.log(Level.INFO, "Se ha pulsado el botón cuenta");
        });
        ...
        itemSorprendeme.addActionListener(e -> {
            ...
            if (!peliculas.isEmpty()) {
                ...
                logger.log(Level.INFO, "Se ha pulsado el botón Sorprendeme");
            } else {
                JOptionPane.showMessageDialog(this, "No hay películas disponibles.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });

        itemMaraton.addActionListener(e -> {
            VentanaMaraton ventanaMaraton = new VentanaMaraton();
            ventanaMaraton.setVisible(true);
            logger.log(Level.INFO, "Se ha pulsado el botón Maraton");
        });
